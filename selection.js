...
`
    ...
    space.innerHTML = 
`<b>Auxiliary Space:</b> O(1) as the only extra memory used is for temporary variables while swapping two values in Array. 
...
async function SelectionSort() {
    ...
    for (let i = 0; i < element.length; i++) {
        ...
        element[i].style.background = 'rgb(0, 235, 54)';
